...
description: QA an analysis before sharing with stakeholders or creating a dashboard -- methodology checks, accuracy verification, and bias detection. Use when reviewing an analysis for errors, checking for survivorship bias, validating aggregation logic, or preparing documentation for reproducibility.
---
